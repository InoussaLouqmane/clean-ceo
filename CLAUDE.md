...
src/
  ...
  scenes/
    CalibrationScene.js  ← scène de calibration temporaire (grille neutre)
  mapLoader.js           ← stub, en attente de l'export Tiled (rôle 5)
```
...
Seul le **module caméra** (pan/zoom/inertie) est fonctionnel, testé sur une grille de
calibration neutre. Aucun bâtiment, aucune économie, aucun clic, aucune vraie carte
n'est encore implémenté — voir STATUS.md pour le détail exact et la prochaine étape.
